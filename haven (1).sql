...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2024 at 10:42 PM
...
(12, 3, 1, 42, '2024-11-28', '09:00:00', 'Edwin Andrews Air Base Golf Club, Governor Ramos Avenue, Sanroe Subdivision, San Roque, Zamboanga City, Zamboanga Peninsula, 7000, Philippines', 'cash', 250.00, '2024-11-26 18:36:56', 'accepted'),
(13, 3, 1, 42, '2024-12-06', '09:00:00', 'Brent Colleges, R.T. Lim Boulevard, Santo Niño, Baliwasan, Zamboanga City, Zamboanga Peninsula, 7000, Philippines', 'cash', 250.00, '2024-11-29 20:27:57', 'completed');
...
(3, 42, 'Computer Repair', 1, '434184476_1064497137977843_3663982541057038331_n.jpg', '2024-09-20 18:57:05', 'approved', '0986786778', 5.00),
...
INSERT INTO `technician_reviews` (`id`, `booking_id`, `user_id`, `technician_id`, `rating`, `comment`, `created_at`) VALUES
(1, 13, 3, 42, 5, 'Best experience\r\n', '2024-11-29 21:28:04');
...
(3, 'sijey', 'sss', 'meow@gmail.com', '$2y$10$9MwWdRz2iJ4Nw33nZR9M.u4QJ75UqRoPqY0I1n0rowHFAkFkg514e', '2024-09-10 17:24:31', 1, 'local', NULL, 'profile_3_1732909682.jpg'),
...
(42, 'Mike', 'Enriquez', 'mike@gmail.com', '$2y$10$FG73v1g4i54CzPk1472BNeB0m.D9u2RWcrhUWpPErK4vZ0rHsdCuK', '2024-09-20 18:57:05', 2, 'local', NULL, 'profile_42_1732914871.png'),
...
--
ALTER TABLE `technician_reviews`
  ADD CONSTRAINT `technician_reviews_ibfk_1` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`id`),
  ADD CONSTRAINT `technician_reviews_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `technician_reviews_ibfk_3` FOREIGN KEY (`technician_id`) REFERENCES `users` (`id`);
